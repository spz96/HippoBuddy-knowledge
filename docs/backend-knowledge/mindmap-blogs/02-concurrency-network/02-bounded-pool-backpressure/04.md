...
> 导图路径：过载 → 阻塞  
> 类型：“有界线程池、队列与背压”中的并发控制节点；编号 4/11

## 1. 学习结论

“阻塞”是“有界线程池、队列与背压”中的并发控制节点。掌握标准是能从线程/状态/协议层说明正常路径、竞争路径、超时路径和关闭路径。
...
- **上一知识点**：[external quota：底层原理、源码与实现](03.md)
- **下一知识点**：[拒绝：底层原理、源码与实现](05.md)
